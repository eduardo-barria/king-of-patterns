 ...
 */
public class Rank3Monster extends AbstractMonsterCard {
  public Rank3Monster(final String name, final Player owner, final int attackPoints,
  ...
  protected boolean hasEnoughTributes(final int tributes) throws CardPlacementException {
    ...
    throw new CardPlacementException(
        "A rank 3 monster requires 2 tributes but " + tributes + " were given.");
  }
}
